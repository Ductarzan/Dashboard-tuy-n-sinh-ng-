        ...
        {active === "meta" ? (
          <>
            ...
            <section className="detail-section">
              ...
              {/* Meta Professional Dashboard 28-Day Comprehensive Metrics matching Meta Business Suite UI */}
              {fanpageInfo.proInsights ? (
                <div className="margin-top-subpanel">
                  <SectionHeading
                    title={`Thông tin chi tiết - Hiệu quả Meta Business Suite (${fanpageInfo.proInsights.periodText})`}
                    subtitle="Báo cáo đối chiếu 6 nhóm chỉ số kinh doanh chính thức của Fanpage Trường Đại học Đông Đô"
                  />
                  <div className="meta-metrics-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "16px", marginBottom: "24px" }}>
                    {/* Card 1: Lượt xem */}
                    <article className="subpanel" style={{ padding: "18px" }}>
                      <div className="flex-between" style={{ marginBottom: "8px" }}>
                        <h4 style={{ fontSize: "15px", fontWeight: 700, margin: 0, color: "#111827" }}>Lượt xem</h4>
                        <span className="meta-card-sub" style={{ fontSize: "12px" }}>Lượt xem ⓘ</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
                        <span style={{ fontSize: "32px", fontWeight: 800, color: "#111827" }}>2,6 triệu</span>
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#15803d", backgroundColor: "#dcfce7", padding: "2px 8px", borderRadius: "4px" }}>↑ 10,6%</span>
                      </div>
                      <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "13px", borderTop: "1px stroke #e5e7eb", paddingTop: "10px" }}>
                        <div className="flex-between">
                          <span>Từ người theo dõi: <strong>7,6%</strong></span>
                          <span style={{ color: "#dc2626", fontWeight: 600 }}>↓ 2,2%</span>
                        </div>
                        <div className="flex-between">
                          <span>Từ người chưa theo dõi: <strong>92,4%</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 0,2%</span>
                        </div>
                        <div className="flex-between" style={{ marginTop: "4px", paddingTop: "6px", borderTop: "1px dashed #e5e7eb" }}>
                          <span>Người xem: <strong>764.790</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 15%</span>
                        </div>
                      </div>
                    </article>

                    {/* Card 2: Lượt theo dõi */}
                    <article className="subpanel" style={{ padding: "18px" }}>
                      <div className="flex-between" style={{ marginBottom: "8px" }}>
                        <h4 style={{ fontSize: "15px", fontWeight: 700, margin: 0, color: "#111827" }}>Lượt theo dõi</h4>
                        <span className="meta-card-sub" style={{ fontSize: "12px" }}>Lượt theo dõi ⓘ</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
                        <span style={{ fontSize: "32px", fontWeight: 800, color: "#111827" }}>398</span>
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#b91c1c", backgroundColor: "#fee2e2", padding: "2px 8px", borderRadius: "4px" }}>↓ 7,2%</span>
                      </div>
                      <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "13px", borderTop: "1px stroke #e5e7eb", paddingTop: "10px" }}>
                        <div className="flex-between">
                          <span>Lượt bỏ theo dõi: <strong>191</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 21,7%</span>
                        </div>
                        <div className="flex-between">
                          <span>Số người theo dõi thực: <strong>207</strong></span>
                          <span style={{ color: "#b91c1c", fontWeight: 600 }}>↓ 23,9%</span>
                        </div>
                      </div>
                    </article>

                    {/* Card 3: Lượt truy cập */}
                    <article className="subpanel" style={{ padding: "18px" }}>
                      <div className="flex-between" style={{ marginBottom: "8px" }}>
                        <h4 style={{ fontSize: "15px", fontWeight: 700, margin: 0, color: "#111827" }}>Lượt truy cập</h4>
                        <span className="meta-card-sub" style={{ fontSize: "12px" }}>Trang Facebook ⓘ</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
                        <span style={{ fontSize: "32px", fontWeight: 800, color: "#111827" }}>30,9K</span>
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#15803d", backgroundColor: "#dcfce7", padding: "2px 8px", borderRadius: "4px" }}>↑ 6,5%</span>
                      </div>
                      <div style={{ fontSize: "13px", color: "#4b5563", paddingTop: "10px", borderTop: "1px stroke #e5e7eb" }}>
                        Lượt ghé thăm trực tiếp trang Facebook Đông Đô từ 28 ngày gần nhất.
                      </div>
                    </article>

                    {/* Card 4: Lượt tương tác */}
                    <article className="subpanel" style={{ padding: "18px" }}>
                      <div className="flex-between" style={{ marginBottom: "8px" }}>
                        <h4 style={{ fontSize: "15px", fontWeight: 700, margin: 0, color: "#111827" }}>Lượt tương tác</h4>
                        <span className="meta-card-sub" style={{ fontSize: "12px" }}>Nội dung ⓘ</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
                        <span style={{ fontSize: "32px", fontWeight: 800, color: "#111827" }}>10,5K</span>
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#15803d", backgroundColor: "#dcfce7", padding: "2px 8px", borderRadius: "4px" }}>↑ 17%</span>
                      </div>
                      <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "13px", borderTop: "1px stroke #e5e7eb", paddingTop: "10px" }}>
                        <div className="flex-between">
                          <span>Từ người theo dõi: <strong>3.158</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 3,4%</span>
                        </div>
                        <div className="flex-between">
                          <span>Từ người chưa theo dõi: <strong>7.360</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 24%</span>
                        </div>
                      </div>
                    </article>

                    {/* Card 5: Video và thước phim */}
                    <article className="subpanel" style={{ padding: "18px" }}>
                      <div className="flex-between" style={{ marginBottom: "8px" }}>
                        <h4 style={{ fontSize: "15px", fontWeight: 700, margin: 0, color: "#111827" }}>Video và thước phim</h4>
                        <span className="meta-card-sub" style={{ fontSize: "12px" }}>Reels & Video ⓘ</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
                        <span style={{ fontSize: "32px", fontWeight: 800, color: "#111827" }}>687,4K</span>
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#15803d", backgroundColor: "#dcfce7", padding: "2px 8px", borderRadius: "4px" }}>↑ 71,2%</span>
                      </div>
                      <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "13px", borderTop: "1px stroke #e5e7eb", paddingTop: "10px" }}>
                        <div className="flex-between">
                          <span>Thời gian xem: <strong>149 ngày 5 giờ</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 63,3%</span>
                        </div>
                      </div>
                    </article>

                    {/* Card 6: Cuộc trò chuyện */}
                    <article className="subpanel" style={{ padding: "18px" }}>
                      <div className="flex-between" style={{ marginBottom: "8px" }}>
                        <h4 style={{ fontSize: "15px", fontWeight: 700, margin: 0, color: "#111827" }}>Cuộc trò chuyện</h4>
                        <span className="meta-card-sub" style={{ fontSize: "12px" }}>Messaging ⓘ</span>
                      </div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
                        <span style={{ fontSize: "32px", fontWeight: 800, color: "#111827" }}>1,1K</span>
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#15803d", backgroundColor: "#dcfce7", padding: "2px 8px", borderRadius: "4px" }}>↑ 9,7%</span>
                      </div>
                      <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "13px", borderTop: "1px stroke #e5e7eb", paddingTop: "10px" }}>
                        <div className="flex-between">
                          <span>Người liên hệ mới: <strong>1.000</strong></span>
                          <span style={{ color: "#15803d", fontWeight: 600 }}>↑ 8,7%</span>
                        </div>
                        <div className="flex-between">
                          <span>Tỷ lệ phản hồi: <strong>83,7%</strong></span>
                          <span style={{ color: "#b91c1c", fontWeight: 600 }}>↓ 2%</span>
                        </div>
                      </div>
                    </article>
                  </div>
