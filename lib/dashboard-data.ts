...
function normalizeIndustryName(value: RawCell) {
  ...
  const aliases: Record<string, string> = {
    ...
    "ngôn ngữ nhật": "Ngôn ngữ Nhật Bản",
    ...
    "quản trị thương mại điện tử": "Quản trị thương mại điện tử",
    "thương mại quốc tế": "Thương mại Quốc tế",
    "logistics và chuỗi cung ứng số": "Logistics và chuỗi cung ứng số",
    "công nghệ thông tin": "Công nghệ thông tin",
    "công nghệ ô tô điện": "Công nghệ ô tô điện",
    "kỹ thuật điện ô tô": "Kỹ thuật Điện ô tô",
    "công nghệ kỹ thuật ô tô": "Công nghệ kỹ thuật ô tô",
    "trí tuệ nhân tạo ứng dụng": "Trí tuệ nhân tạo ứng dụng",
